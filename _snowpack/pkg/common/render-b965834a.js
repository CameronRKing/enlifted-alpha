...
function hyperscript(selector) {
	...
	try { throw new Error(); } catch(e) {
		...
		if (match) vnode$1.meta = { src: match[0] };
	}
...
var componentCreated = componentcreated.run;
...
var render = function($window) {
	...
	function initComponent(vnode$1, hooks) {
		...
		componentCreated(vnode$1, callHook);
...
export { hyperscript_1 as a, hasOwn as b, componentcreated as c, hyperscriptVnode as h, render as r, vnode as v };
//# sourceMappingURL=render-b965834a.js.map
