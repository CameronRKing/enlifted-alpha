...
import { _ as __extends$1, a as __awaiter, b as __generator, g as __spreadArrays } from '../common/tslib.es6-5194c621.js';
import { g as getUA, a as isMobileCordova, b as isReactNative, c as isElectron, d as isIE, e as isUWP, h as isBrowserExtension, L as LogLevel, C as Component, f as firebase$1, j as Logger } from '../common/index.esm-a3f0912f.js';
 ...
 */ function k$1(t) {
    ...
    if (A$1.logLevel <= LogLevel.DEBUG) {
        var i = e.map(S$1);
        A$1.debug.apply(A$1, __spreadArrays([ "Firestore (8.1.2): " + t ], i));
    }
}
...
function x$1(t) {
    ...
    if (A$1.logLevel <= LogLevel.ERROR) {
        var i = e.map(S$1);
        A$1.error.apply(A$1, __spreadArrays([ "Firestore (8.1.2): " + t ], i));
    }
}
...
function O$1(t) {
    ...
    if (A$1.logLevel <= LogLevel.WARN) {
        var i = e.map(S$1);
        A$1.warn.apply(A$1, __spreadArrays([ "Firestore (8.1.2): " + t ], i));
    }
}
 ...
 */ var V$1 = {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.V !== e ? (k$1("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (R$1("string" == typeof n.accessToken), new q$1(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.p = function() {
        ...
        return R$1(null === t || "string" == typeof t), new N$1(t);
    }, t;
}(), F$1 = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new F$1(this.v, this.S));
    }, t.prototype.A = function(t) {
...
/** Helper to compare arrays using isEqual(). */ function W$1(t, e, n) {
 ...
 */ var Q$1 = /** @class */ function() {
     ...
     */
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new C(V$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new C(V$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new C(V$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new C(V$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    /**
...
}(), Y$1 = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return __extends$1(n, e), n.prototype.L = function(t, e, r) {
        return new n(t, e, r);
    ...
    n.Y = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var u = o[i];
            if (u.indexOf("//") >= 0) throw new C(V$1.INVALID_ARGUMENT, "Invalid segment (" + u + "). Paths must not contain // in them.");
...
}(J$1), H$1 = /^[_a-zA-Z][_a-zA-Z0-9]*$/, X$1 = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return __extends$1(n, e), n.prototype.L = function(t, e, r) {
    ...
    n.nt = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new C(V$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, u = !1; i < t.length; ) {
            var s = t[i];
            if ("\\" === s) {
                if (i + 1 === t.length) throw new C(V$1.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new C(V$1.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === s ? (u = !u, i++) : "." !== s || u ? (r += s, i++) : (o(), i++);
        }
        if (o(), u) throw new C(V$1.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.X = function() {
        return new n([]);
    }, n;
}(J$1), Z$1 = /** @class */ function() {
    function t(t) {
        this.path = t;
    }
    return t.st = function(e) {
        return new t(Y$1.Y(e));
    }, t.it = function(e) {
        return new t(Y$1.Y(e).B(5));
    }, 
    /** Returns true if the document is in the specified collectionId. */ t.prototype.rt = function(t) {
        return this.path.length >= 2 && this.path.get(this.path.length - 2) === t;
    }, t.prototype.isEqual = function(t) {
        return null !== t && 0 === Y$1.$(this.path, t.path);
    }, t.prototype.toString = function() {
        return this.path.toString();
    }, t.$ = function(t, e) {
        return Y$1.$(t.path, e.path);
    }, t.ot = function(t) {
        return t.length % 2 == 0;
    }, 
    /**
 ...
 */ function dt(t) {
    ...
    return x$1("GRPC error has no .code"), V$1.UNKNOWN;
    switch (t) {
      case ct.OK:
        return V$1.OK;
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.He = function(t) {
        ...
        return this.Oe = _t(), this.Me = Ft(), this.ke = new gt(G$1), i;
    }, 
    /**
...
/** Extracts the backend's type order for the provided value. */ function Jt(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? Wt(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : P$1();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Yt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return W$1(t.arrayValue.values || [], e.arrayValue.values || [], Yt);
...
function Te(t, e) {
    var n = Ie(e);
    if (n.get(1) !== t.t.projectId) throw new C(V$1.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.t.projectId);
    if (n.get(3) !== t.t.database) throw new C(V$1.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.t.database);
    return new Z$1(ke(n));
}
...
function Ae(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? Y$1.X() : ke(e);
}

function De(t) {
    return new Y$1([ "projects", t.t.projectId, "databases", t.t.database ]).J();
}

function ke(t) {
    return R$1(t.length > 4 && "documents" === t.get(4)), t.B(5)
...
function Se(t, e) {
    ...
    if (e.transform) {
        var s = Te(t, e.transform.document), a = e.transform.fieldTransforms.map((function(e) {
            return function(t, e) {
                var n = null;
                if ("setToServerValue" in e) R$1("REQUEST_TIME" === e.setToServerValue), n = new Ye; else if ("appendMissingElements" in e) {
        ...
        return R$1(!0 === n.exists), new wn(s, a);
    }
    if (e.verify) {
        var c = Te(t, e.verify);
        return new En(c, n);
 ...
 */ var on = /** @class */ function() {
    ...
    return t.prototype.un = function(t) {
        ...
        return W$1(this.fields, t.fields, (function(t, e) {
            return t.isEqual(e);
        }));
    }, t;
}(), un = function(t, e) {
 ...
 */ function fn(t, e, n) {
    return t instanceof yn ? function(t, e, n) {
        ...
        if (R$1(null != n.transformResults), !cn(t.rn, e)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
...
function dn(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.rn.isEqual(e.rn) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.en.isEqual(e.en) : 2 /* Transform */ !== t.type || W$1(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
            return t.field.isEqual(e.field) && function(t, e) {
                return t instanceof He && e instanceof He || t instanceof Ze && e instanceof Ze ? W$1(t.elements, e.elements, Yt) : t instanceof en && e instanceof en ? Yt(t.nn, e.nn) : t instanceof Ye && e instanceof Ye;
...
var Dn = function(t, e) {
    ...
    return __extends$1(n, e), n.prototype.field = function(t) {
    ...
    return __extends$1(n, e), n.prototype.toString = function() {
 ...
 */ var cr = /** @class */ function() {
    ...
    t.prototype.vn = function(t) {
        ...
        return this.batchId === t.batchId && W$1(this.mutations, t.mutations, (function(t, e) {
            return dn(t, e);
        })) && W$1(this.baseMutations, t.baseMutations, (function(t, e) {
            return dn(t, e);
        }));
    }, t;
}(), hr = /** @class */ function() {
    ...
    return t.from = function(e, n, r) {
        R$1(e.mutations.length === r.length);
...
var Ir = /** @class */ function() {
    ...
    t.prototype.Bs = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && k$1("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.Ms + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    function t(e, n, r) {
        ...
        // log on 12.2.
        12.2 === t.js(getUA()) && x$1("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    return t.delete = function(t) {
        return k$1("SimpleDb", "Removing database:", t), xr(window.indexedDB.deleteDatabase(t)).Ln();
    }, 
    ...
    t.prototype.Xs = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.db ? [ 3 /*break*/ , 2 ] : (k$1("SimpleDb", "Opening database:", this.name), 
                    e = this, [ 4 /*yield*/ , new Promise((function(e, n) {
                        ...
                        i.onsuccess = function(t) {
                            ...
                            "VersionError" === r.name ? n(new C(V$1.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new Nr(t, r));
                        }, i.onupgradeneeded = function(t) {
                            k$1("SimpleDb", 'Database "' + r.name + '" requires upgrade from version:', t.oldVersion);
                            var e = t.target.result;
                            r.Ws.createOrUpgrade(e, i.transaction, t.oldVersion, r.version).next((function() {
                                k$1("SimpleDb", "Database upgrade to version " + r.version + " complete");
                            }));
                        };
                    })) ]);
                    ...
                    e = "readonly" === r, u = 0, s = function() {
                        ...
                        return __generator(this, (function(n) {
                            switch (n.label) {
                              ...
                              case 4:
                                return h = n.sent(), f = "FirebaseError" !== h.name && u < 3, k$1("SimpleDb", "Transaction failed with error:", h.message, "Retrying:", f), 
 ...
 */ var Dr = /** @class */ function() {
    ...
    return t.open = function(e, n, r, i) {
        ...
        t && this.ci.reject(t), this.aborted || (k$1("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
    ...
    return t.prototype.put = function(t, e) {
        var n;
        return void 0 !== e ? (k$1("SimpleDb", "PUT", this.store.name, t, e), n = this.store.put(e, t)) : (k$1("SimpleDb", "PUT", this.store.name, "<auto-key>", t), 
    ...
    t.prototype.add = function(t) {
        return k$1("SimpleDb", "ADD", this.store.name, t, t), xr(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
            ...
            return void 0 === n && (n = null), k$1("SimpleDb", "GET", e.store.name, t, n), n;
        }));
    }, t.prototype.delete = function(t) {
        return k$1("SimpleDb", "DELETE", this.store.name, t), xr(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return k$1("SimpleDb", "COUNT", this.store.name), xr(this.store.count());
        ...
        k$1("SimpleDb", "DELETE ALL", this.store.name);
 ...
 */ var Lr = /** @class */ function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.mi && (this.clearTimeout(), this.Ti.reject(new C(V$1.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.Di = function() {
            var e = Rr();
            e && k$1("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.Si.Qs();
        };
        var e = Rr();
    ...
    t.prototype.ki = function() {
                ...
                switch (n.label) {
                  ...
                  case 3:
                    ...
                    // Failure will be handled by AsyncQueue
                                        return k$1("AsyncQueue", "Operation failed with retryable error: " + t), 
                    [ 3 /*break*/ , 4 ];
        ...
        var e = this, n = this.Pi.then((function() {
            return e.vi = !0, t().catch((function(t) {
                ...
                throw e.pi = t, e.vi = !1, x$1("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
function Cr(t, e) {
    if (x$1("AsyncQueue", e + ": " + t), Ar(t)) return new C(V$1.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
var jr = /** @class */ function() {
    ...
    return t.prototype.start = function(t) {
        ...
        k$1("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this.ar = this.di.Us("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
            return __awaiter(r, void 0, void 0, (function() {
                ...
                return __generator(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return Ar(e = n.sent()) ? (k$1("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    t.prototype.Ar = function(t, e) {
        ...
        var n = this;
        return -1 === this.params.Xi ? (k$1("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        lr.resolve(Ur)) : this.Pr(t).next((function(r) {
            return r < n.params.Xi ? (k$1("LruGarbageCollector", "Garbage collection skipped; Cache size " + r + " is lower than threshold " + n.params.Xi), 
            Ur) : n.gr(t, e);
        }));
        ...
        return this.wr(t, this.params.Zi).next((function(e) {
            ...
            return e > h.params.tr ? (k$1("LruGarbageCollector", "Capping sequence numbers to collect down to the maximum of " + h.params.tr + " from " + e), 
            ...
            return c = Date.now(), D$1() <= LogLevel.DEBUG && k$1("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - f) + "ms\n\tDetermined least recently used " + r + " in " + (s - o) + "ms\n\tRemoved " + i + " targets in " + (a - s) + "ms\n\tRemoved " + t + " documents in " + (c - a) + "ms\nTotal Duration: " + (c - f) + "ms"), 
            lr.resolve({
                zi: !0,
                Hi: r,
                Ji: i,
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.ws = function(t, e, n, r) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var s = i.vr(e, o);
            return (Ln(e) || Vn(e)) && i.br(e.limitType, s, r, n) ? i.pr(t, e) : (D$1() <= LogLevel.DEBUG && k$1("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), Gn(e)), 
    ...
    t.prototype.br = function(t, e, n, r) {
        ...
        return D$1() <= LogLevel.DEBUG && k$1("QueryEngine", "Using full collection scan to execute query:", Gn(e)), 
        this.Vr.ws(t, e, $.min());
    }, t;
}();
 ...
 */ function Qr(t) {
    ...
    var e = t.length;
    if (R$1(e >= 2), 2 === e) return R$1("" === t.charAt(0) && "" === t.charAt(1)), Y$1.X();
...
/** Decodes a remote document from storage locally to a Document. */ function Jr(t, e) {
    ...
    if (e.noDocument) {
        var n = Z$1.ct(e.noDocument.path), r = ti(e.noDocument.readTime);
        return new xn(n, r, {
            hasCommittedMutations: !!e.hasCommittedMutations
        });
    }
    if (e.unknownDocument) {
        var i = Z$1.ct(e.unknownDocument.path), o = ti(e.unknownDocument.version);
        return new On(i, o);
    }
    return P$1();
}
...
/** Decodes a DbTarget into TargetData */ function ni(t) {
    ...
    return void 0 !== t.query.documents ? (R$1(1 === (n = t.query).documents.length), 
...
/** A mutation queue for a specific user, backed by IndexedDB. */ var oi = /** @class */ function() {
    ...
    return t.Nr = function(e, n, r, i) {
        ...
        return R$1("" !== e.uid), new t(e.u() ? e.uid : "", n, r, i);
        ...
        return ai(t).get(e).next((function(t) {
            return t ? (R$1(t.userId === n.userId), ei(n.serializer, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.$r = function(t, e) {
        ...
        return ai(t)._i({
            ...
            e.userId === n.userId && (R$1(e.batchId >= r), o = ei(n.serializer, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        // the given documentKey.
            ...
            return ai(t).get(c).next((function(t) {
                if (!t) throw P$1();
                R$1(t.userId === n.userId), o.push(ei(n.serializer, t));
            }));
            u.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = e.path, i = r.length + 1, o = Ti.prefixForPath(this.userId, r), u = IDBKeyRange.lowerBound(o), s = new gt(G$1);
        return ci(t)._i({
            range: u
        }, (function(t, e, o) {
        ...
        return e.forEach((function(e) {
            i.push(ai(t).get(e).next((function(t) {
                if (null === t) throw P$1();
                R$1(t.userId === n.userId), r.push(ei(n.serializer, t));
            })));
        })), lr.qn(i).next((function() {
            return r;
        }));
 ...
 */ var fi = /** @class */ function() {
    ...
    return __extends$1(n, e), n.prototype.Zn = function(t) {
 ...
 */ var mi = /** @class */ function() {
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.K(), n = t.q(), r = this.index[e] || new gt(Y$1.$), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.K(), n = t.q(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new gt(Y$1.$)).H();
    }, t;
}(), wi = /** @class */ function() {
    function t(t) {
        this.serializer = t;
...
var qi = __spreadArrays(__spreadArrays(__spreadArrays(__spreadArrays([ Ii.store, Ei.store, Ti.store, Di.store, xi.store, _i.store, Si.store, Oi.store ], [ Li.store ]), [ ki.store ]), [ Pi.store ]), [ Vi.store, Ci.store ]), Mi = /** @class */ function() {
    function t(t) {
        this.serializer = t;
    }
 ...
 */ var ji = /** @class */ function() {
     ...
     */    return t.prototype.Mr = function(t, e) {
        ...
        var n = [], r = IDBKeyRange.bound([ e, "" ], [ K$1(e), "" ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
 ...
 */ var zi = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.Ao(t).next((function(t) {
            return $.N(new Q$1(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
        ...
        return this.Co(t, e.targetId).next((function() {
            ...
            return R$1(e.targetCount > 0), e.targetCount -= 1, n.Ro(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.bo = function(t, e) {
        ...
        return r._i({
            ...
            var r = Qr(t[1]), o = new Z$1(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.zr = function(t, e) {
        var n = Gr(e.path), r = IDBKeyRange.bound([ n ], [ K$1(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return Qi(t)._i({
 ...
 */ var $i = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Ji = /** @class */ function(e) {
    ...
    h) {
        ...
        }, !t.Gs()) throw new C(V$1.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
    ...
    t.prototype.start = function() {
        ...
        // do.
            ...
            throw new C(V$1.FAILED_PRECONDITION, $i);
    ...
    t.prototype.tc = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            ...
            return k$1("IndexedDbPersistence", "Failed to extend owner lease: ", e), t.isPrimary;
            if (!t.allowTabSynchronization) throw e;
            return k$1("IndexedDbPersistence", "Releasing owner lease after error during lease refresh", e), 
            /* isPrimary= */ !1;
        })).then((function(e) {
    ...
    t.prototype.uc = function(t) {
        ...
        return this.qo ? lr.resolve(!0) : Hi(t).get(_i.key).next((function(n) {
            ...
            return e.isPrimary !== t && k$1("IndexedDbPersistence", "Client " + (t ? "is" : "is not") + " eligible for a primary lease."), 
            t;
        }));
    ...
    t.prototype.gc = function() {
        ...
        var r = this;
        k$1("IndexedDbPersistence", "Starting transaction:", t);
        ...
        return this.Jo.runTransaction(t, o, qi, (function(o) {
            return i = new Ji(o, r.Uo ? r.Uo.next() : _r.Ds), "readwrite-primary" === e ? r.cc(i).next((function(t) {
                ...
                r.Cs.Mi((function() {
                    return r.zo(!1);
                })), new C(V$1.FAILED_PRECONDITION, mr);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.Dc = function(t) {
        var e = this;
        return Hi(t).get(_i.key).next((function(t) {
            if (null !== t && e.dc(t.leaseTimestampMs, 5e3) && !e.Tc(t.ownerId) && !e.lc(t) && !(e.qo || e.allowTabSynchronization && t.allowTabSynchronization)) throw new C(V$1.FAILED_PRECONDITION, $i);
        }));
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.ac = function(t) {
        ...
        return n.get(_i.key).next((function(t) {
            return e.lc(t) ? (k$1("IndexedDbPersistence", "Releasing primary lease."), n.delete(_i.key)) : lr.resolve();
        }));
    }, 
    ...
    t.prototype.Tc = function(t) {
        ...
        try {
            ...
            return k$1("IndexedDbPersistence", "Client '" + t + "' " + (n ? "is" : "is not") + " zombied in LocalStorage"), 
            n;
        } catch (t) {
...
function io(t, r) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = L$1(t), i = e.rs, o = e.Bc, [ 4 /*yield*/ , e.persistence.runTransaction("Handle user change", "readonly", (function(t) {
        ...
        return function(t, e, n, r) {
            ...
            return o.forEach((function(t) {
                u = u.next((function() {
                    ...
                    R$1(null !== u), (!o || o.version.F(u) < 0) && ((o = i.yn(t, o, n)) && 
 ...
 */ function so(t, e) {
     ...
     */
                    function(t, e, n) {
                        ...
                        return R$1(e.resumeToken.ht() > 0), 0 === t.resumeToken.ht() || (
        ...
        i) {
            ...
            return n.forEach((function(t) {
                ...
                return n.forEach((function(n, o) {
                    ...
                    i = i.Tt(n, o)) : k$1("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", u.version, " Watch version:", o.version);
                })), i;
            }));
...
function ho(t, r, i) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(n) {
            switch (n.label) {
              case 0:
                e = L$1(t), o = e.Mc.get(r), u = i ? "readwrite" : "readwrite-primary", n.label = 1;
              ...
              case 4:
                ...
                // don't define exact LRU semantics so this is acceptable.
                                return k$1("LocalStore", "Failed to update sequence numbers for target " + r + ": " + s), 
                [ 3 /*break*/ , 5 ];
 ...
 */ function fo(t, e, n) {
    var r = L$1(t), i = $.min(), o = Dt();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = L$1(t), i = r.kc.get(n);
...
// PORTING NOTE: Multi-Tab only.
function lo(t, e) {
    var n = L$1(t), r = L$1(n.Yo), i = n.Mc.get(e);
...
function po(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = L$1(t), i = _t(), o = Hr(n), u = di(e), s = IDBKeyRange.lowerBound(o, !0);
            return u._i({
 ...
 */ function yo(t) {
    return __awaiter(this, void 0, void 0, (function() {
        return __generator(this, (function(e) {
            ...
            return k$1("LocalStore", "Unexpectedly lost primary lease"), [ 2 /*return*/ ];
        }));
    }));
}
 ...
 */ var mo = /** @class */ function() {
            ...
            return __generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    x$1(r.toString()), x$1("Using maximum backoff delay to prevent overloading the backend."), 
    ...
    t.prototype.ru = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new C(V$1.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.au(e);
            }));
        }));
    ...
    t.prototype.cu = function(t) {
        ...
        return function(n) {
            e.Cs.Ri((function() {
                return e.Hc === t ? n() : (k$1("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return __extends$1(n, e), n.prototype.hu = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.tn ? (R$1(void 0 === e || "string" == typeof e), at.fromBase64String(e || "")) : (R$1(void 0 === e || e instanceof Uint8Array), 
    ...
    return __extends$1(n, e), Object.defineProperty(n.prototype, "Tu", {
        /**
    ...
    n.prototype.start = function() {
        ...
        R$1(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Eu) {
            // A successful first write response means the stream is healthy,
            // Note, that we could consider a successful handshake healthy, however,
            // the write itself might be causing an error we want to back off from.
            this.Si.reset();
            var e = function(t, e) {
                return t && t.length > 0 ? (R$1(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
        ...
        // The first response is always the handshake response
                return R$1(!t.writeResults || 0 === t.writeResults.length), this.Eu = !0, 
        this.listener.Au();
    }, 
    /**
    ...
    return __extends$1(n, e), n.prototype.gu = function() {
        if (this.Pu) throw new C(V$1.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.Su ? (x$1(e), this.Su = !1) : k$1("OnlineStateTracker", e);
        ...
        i.Ri((function() {
            return __awaiter(s, void 0, void 0, (function() {
                return __generator(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return So(this) ? (k$1("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return __awaiter(this, void 0, void 0, (function() {
                                var e;
                                return __generator(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = L$1(t)).Bu.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , To(e) ];
    ...
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(a) {
            switch (a.label) {
              ...
              case 3:
                return o = a.sent(), k$1("RemoteStore", "Failed to remove targets %s: %s ", r.targetIds.join(","), o), 
                [ 4 /*yield*/ , Co(t, o) ];
              ...
              case 11:
                return k$1("RemoteStore", "Failed to raise snapshot:", s = a.sent()), [ 4 /*yield*/ , Co(t, s) ];
                ...
                t.di.Mi((function() {
                    return __awaiter(o, void 0, void 0, (function() {
                        return __generator(this, (function(e) {
                            switch (e.label) {
                              case 0:
                                return k$1("RemoteStore", "Retrying IndexedDB access"), [ 4 /*yield*/ , i() ];
...
function Mo(t) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(n) {
            switch (n.label) {
              case 0:
                e = L$1(t), r = Qo(e), i = e.$u.length > 0 ? e.$u[e.$u.length - 1].batchId : -1, n.label = 1;
                ...
                return r && Qo(t).Tu ? [ 4 /*yield*/ , function(t, r) {
                    return __awaiter(this, void 0, void 0, (function() {
                        ...
                        return __generator(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return pt(i = r.code) && i !== V$1.ABORTED ? (e = t.$u.shift(), 
 ...
 */ function Wo(t, r) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = L$1(t), r ? (e.Bu.delete(2 /* IsSecondary */), [ 4 /*yield*/ , Eo(e) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return n.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return (r) ? [ 3 /*break*/ , 4 ] : (e.Bu.add(2 /* IsSecondary */), [ 4 /*yield*/ , To(e) ]);

              case 3:
                n.sent(), e.Ku.set("Unknown" /* Unknown */), n.label = 4;
        ...
        return __awaiter(r, void 0, void 0, (function() {
            return __generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 3:
                    e.sent(), t.$u.length > 0 && (k$1("RemoteStore", "Stopping write stream with " + t.$u.length + " pending writes"), 
                    t.$u = []), e.label = 4;
...
function Yo(t, r) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(n) {
            switch (n.label) {
              case 0:
                if (e = L$1(t), i = r.query, o = !1, (u = e.queries.get(i)) || (o = !0, u = new $o), 
                !o) return [ 3 /*break*/ , 4 ];
                n.label = 1;
...
function Ho(t, r) {
    return __awaiter(this, void 0, void 0, (function() {
        var e, i, o, u, s;
        return __generator(this, (function(n) {
            return e = L$1(t), i = r.query, o = !1, (u = e.queries.get(i)) && (s = u.listeners.indexOf(r)) >= 0 && (u.listeners.splice(s, 1), 
 ...
 */ var eu = /** @class */ function() {
    ...
    t.prototype.Ia = function(t) {
        var e = this, n = new Z$1(new Y$1([])), r = new ru(n, t), i = new ru(n, t + 1), o = [];
        ...
        var e = new Z$1(new Y$1([])), n = new ru(e, t), r = new ru(e, t + 1), i = Dt();
    ...
    return t._a = function(t, e) {
        return Z$1.$(t.key, e.key) || G$1(t.Ra, e.Ra);
    }, 
    /** Compare by ID then by key */ t.da = function(t, e) {
        return G$1(t.Ra, e.Ra) || Z$1.$(t.key, e.key);
    }, t;
}();
...
var su = /** @class */ function() {
    ...
    return t.Pa = function(e, n, r) {
        ...
        o ? new t(e, n, i.state, u) : (x$1("SharedClientState", "Failed to parse mutation state for ID '" + n + "': " + r), 
        null);
    ...
    return t.Pa = function(e, n) {
        ...
        i ? new t(e, r.state, o) : (x$1("SharedClientState", "Failed to parse target state for ID '" + e + "': " + n), 
        null);
    }, t.prototype.ga = function() {
        var t = {
            state: this.state,
    ...
    function t(t, e, n, r, i) {
        ...
        this.pu = null, this.ps = null, this.ba = this.Sa.bind(this), this.Da = new vt(G$1), 
        this.lr = !1, 
        /**
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.Gs = function(t) {
        ...
        return k$1("SharedClientState", "READ", t, e), e;
    }, t.prototype.setItem = function(t, e) {
        k$1("SharedClientState", "SET", t, e), this.storage.setItem(t, e);
    }, t.prototype.removeItem = function(t) {
        k$1("SharedClientState", "REMOVE", t), this.storage.removeItem(t);
    }, t.prototype.Sa = function(t) {
        var r = this, i = t;
        // Note: The function is typed to take Event to be interface-compatible with
        // `Window.addEventListener`.
                if (i.storageArea === this.storage) {
            if (k$1("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.Na) return void x$1("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.Cs.Mi((function() {
                return __awaiter(r, void 0, void 0, (function() {
                    var t, e, r, o, u, s;
                    return __generator(this, (function(n) {
    ...
    t.prototype.Ba = function(t) {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.va.Eh(t.batchId, t.state, t.error) ] : (k$1("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
...
/** Stops listening to the query. */ function Iu(t, r) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = L$1(t), i = e.Qh.get(r), (o = e.Kh.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (e.Kh.set(i.targetId, o.filter((function(t) {
                    return !Bn(t, r);
            ...
            switch (n.label) {
              ...
              case 1:
                return n.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r = L$1(t), i = Q$1.now(), o = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), Dt());
              ...
              case 2:
                return o = n.sent(), e.Bh.Wa(o.batchId), function(t, e, n) {
                    ...
                    r || (r = new vt(G$1)), r = r.Tt(e, n), t.Hh[t.currentUser.h()] = r;
            ...
            switch (n.label) {
              ...
              case 2:
                ...
                r.re.forEach((function(t, n) {
                    ...
                    R$1(t._e.size + t.fe.size + t.de.size <= 1), t._e.size > 0 ? r.kh = !0 : t.fe.size > 0 ? R$1(r.kh) : t.de.size > 0 && (R$1(r.kh), 
                    r.kh = !1));
                })), [ 4 /*yield*/ , qu(e, i, r) ];
    ...
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(n) {
            switch (n.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (e = L$1(t)).Bh.th(r, "rejected", i), o = e.Gh.get(r), (u = o && o.key) ? (s = (s = new vt(Z$1.$)).Tt(u, new xn(u, $.min())), 
                a = Dt().add(u), c = new Rt($.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new gt(G$1), s, a), [ 4 /*yield*/ , Tu(e, c) ]) : [ 3 /*break*/ , 2 ];
...
function Du(t, r) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(n) {
            switch (n.label) {
              case 0:
                e = L$1(t), i = r.batch.batchId, n.label = 1;
                ...
                return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        ...
                        return n.rs.kr(t, e).next((function(e) {
                            return R$1(null !== e), r = e.keys(), n.rs.Qr(t, e);
                        })).next((function() {
                            return n.rs.Gr(t);
                        })).next((function() {
                            return n.Bc._s(t, r);
 ...
 */ function xu(t, r) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(n) {
            switch (n.label) {
              case 0:
                So((e = L$1(t)).$h) || k$1("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                n.label = 1;
...
function Su(t, e, n) {
    var r = L$1(t), i = r.Hh[r.currentUser.h()];
...
function Lu(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof du ? (t.zh.Oo(o.key, e), Vu(t, o)) : o instanceof vu ? (k$1("SyncEngine", "Document no longer in limbo: " + o.key), 
...
function Vu(t, e) {
    var n = e.key;
    t.jh.get(n) || (k$1("SyncEngine", "New document in limbo: " + n), t.Wh.push(n), Cu(t));
}
...
function qu(t, r, i) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = L$1(t), u = [], s = [], a = [], o.Qh.W() ? [ 3 /*break*/ , 3 ] : (o.Qh.forEach((function(t, e) {
                            ...
                            switch (n.label) {
                              ...
                              case 3:
                                ...
                                // would have, but it should not invalidate the integrity of the data.
                                                                return k$1("LocalStore", "Failed to update sequence numbers: " + i), 
                                [ 3 /*break*/ , 4 ];
...
function Mu(t, r) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(n) {
            switch (n.label) {
              case 0:
                return (e = L$1(t)).currentUser.isEqual(r) ? [ 3 /*break*/ , 3 ] : (k$1("SyncEngine", "User change. New user:", r.h()), 
                [ 4 /*yield*/ , io(e.Ou, r) ]);
              ...
              case 1:
                ...
                function(t, e) {
                    t.Jh.forEach((function(t) {
                        t.forEach((function(t) {
                            t.reject(new C(V$1.CANCELLED, "'waitForPendingWrites' promise is rejected due to a user change."));
                        }));
                    })), t.Jh.clear();
                }(e), 
 ...
 */ function Fu(t, r) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(n) {
            switch (n.label) {
              case 0:
                return [ 4 /*yield*/ , fo((e = L$1(t)).Ou, r.query, 
                /* usePreviousResults= */ !0) ];
...
function ju(t) {
    return __awaiter(this, void 0, void 0, (function() {
        var e;
        return __generator(this, (function(n) {
            return [ 2 /*return*/ , po((e = L$1(t)).Ou).then((function(t) {
                return qu(e, t);
            })) ];
        }));
    }));
        ...
        return __generator(this, (function(n) {
            switch (n.label) {
              ...
              case 6:
                ...
                // as applicable.
                k$1("SyncEngine", "Cannot apply mutation batch with id: " + r), n.label = 7;
...
function zu(t, r) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(n) {
            switch (n.label) {
              case 0:
                return Ju(e = L$1(t)), Yu(e), !0 !== r || !0 === e.Xh ? [ 3 /*break*/ , 3 ] : (i = e.Bh.Ua(), 
                [ 4 /*yield*/ , Gu(e, i.H()) ]);
              ...
              case 5:
                ...
                function(t) {
                    ...
                    e.Gh.forEach((function(t, n) {
                        Ao(e.$h, n);
                    })), e.zh.ma(), e.Gh = new Map, e.jh = new vt(Z$1.$);
...
function Ku(t) {
    var e = L$1(t);
    return L$1(L$1(e.Ou).persistence).gc();
}
        ...
        return __generator(this, (function(n) {
            switch (n.label) {
              case 0:
                ...
                k$1("SyncEngine", "Ignoring unexpected query state notification."), [ 3 /*break*/ , 8 ]) : [ 3 /*break*/ , 1 ];
        ...
        return __generator(this, (function(d) {
            switch (d.label) {
              ...
              case 1:
                ...
                k$1("SyncEngine", "Adding an already active target " + s), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , lo(e.Ou, s) ]) : [ 3 /*break*/ , 6 ];
...
var Hu = /** @class */ function() {
    ...
    return t.prototype.Fr = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                Z$1.ot(i) || (i = i.child(""));
        var o = new ru(new Z$1(i), 0), u = new gt(G$1);
        ...
        var n = this;
        R$1(0 === this.cl(e.batchId, "removed")), this.rs.shift();
        var r = this.sl;
     ...
     * HTTP).
     */
    return __extends$1(n, e), n.prototype.Ll = function(t, e, n, r) {
                ...
                try {
                    switch (u.getLastErrorCode()) {
                      ...
                      case ErrorCode.TIMEOUT:
                        k$1("Connection", 'RPC "' + t + '" timed out'), o(new C(V$1.DEADLINE_EXCEEDED, "Request time out"));
                        break;

                      case ErrorCode.HTTP_ERROR:
                        var n = u.getStatus();
                        if (k$1("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", u.getResponseText()), 
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new C(s, r.message));
                            } else o(new C(V$1.UNKNOWN, "Server responded with status " + u.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new C(V$1.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var u = n.join("");
        k$1("Connection", "Creating WebChannel: " + u, o);
        var s = r.createWebChannel(u, o), d = !1, v = !1, y = new os({
            pl: function(t) {
                v ? k$1("Connection", "Not sending because WebChannel is closed:", t) : (d || (k$1("Connection", "Opening WebChannel transport."), 
                s.open(), d = !0), k$1("Connection", "WebChannel sending:", t), s.send(t));
            },
            vl: function() {
                return s.close();
            }
        ...
        return I(s, WebChannel.EventType.OPEN, (function() {
            v || k$1("Connection", "WebChannel transport opened.");
        })), I(s, WebChannel.EventType.CLOSE, (function() {
            v || (v = !0, k$1("Connection", "WebChannel transport closed"), y.Nl());
        })), I(s, WebChannel.EventType.ERROR, (function(t) {
            v || (v = !0, O$1("Connection", "WebChannel transport errored:", t), y.Nl(new C(V$1.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!v) {
                ...
                } else k$1("Connection", "WebChannel received:", n), y.xl(n);
            }
    ...
    return t.prototype.yu = function(t, e, n, r) {
        ...
        return this.$l(o, r), this.Ll(t, i, o, n).then((function(t) {
            return k$1("RestConnection", "Received: ", t), t;
        }), (function(e) {
    ...
    return __extends$1(i, r), i.prototype.initialize = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(e) {
                switch (e.label) {
                  case 0:
    ...
    return __extends$1(i, r), i.prototype.initialize = function(t) {
        ...
        var e = Pr();
        if (!lu.Gs(e)) throw new C(V$1.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        ...
        return function(t) {
            return __awaiter(this, void 0, void 0, (function() {
                ...
                return __generator(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = L$1(t), k$1("RemoteStore", "RemoteStore shutting down."), e.Bu.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , To(e) ];
 ...
 */
function vs(t, e, n) {
    if (!n) throw new C(V$1.INVALID_ARGUMENT, "Function " + t + "() cannot be called with an empty " + e + ".");
}
...
function ys(t, e) {
    ...
    if (void 0 !== e.mergeFields && void 0 !== e.merge) throw new C(V$1.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
 ...
 */ function ms(t, e, n, r) {
    if (!0 === e && !0 === r) throw new C(V$1.INVALID_ARGUMENT, t + " and " + n + " cannot be used together.");
}
 ...
 */ function gs(t) {
    if (!Z$1.ot(t)) throw new C(V$1.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function ws(t) {
    if (Z$1.ot(t)) throw new C(V$1.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
...
e) {
    ...
    t = t.o_), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new C(V$1.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var n = bs(t);
        throw new C(V$1.INVALID_ARGUMENT, "Expected type '" + e.name + "', but it was: " + n);
    }
    return t;
}

function Is(t, e) {
    if (e <= 0) throw new C(V$1.INVALID_ARGUMENT, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
...
function(t) {
    ...
    return __extends$1(n, e), n.prototype.c_ = function(t) {
...
var As = /** @class */ function(e) {
     ...
     */
    function t(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new C(V$1.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new C(V$1.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.d_ = t, this.w_ = e;
    }
     ...
     */
    t.prototype.C = function(t) {
        return G$1(this.d_, t.d_) || G$1(this.w_, t.w_);
    }, t;
}(), Ss = /** @class */ function() {
    /** @hideconstructor */
    function t(t) {
     ...
     */    return t.fromBase64String = function(e) {
        try {
            ...
            throw new C(V$1.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + e);
        }
    }, 
    /**
    ...
    function t(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new C(V$1.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new C(V$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    ...
    /** @hideconstructor */
    function t(t, e) {
        this.T_ = "(lite)", this.I_ = new Ls({}), this.m_ = !1, t instanceof T$1 ? (this.A_ = t, 
        this.R_ = new M$1) : (this.P_ = t, this.A_ = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new C(V$1.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
    ...
    return Object.defineProperty(t.prototype, "app", {
         ...
         */
        get: function() {
            if (!this.P_) throw new C(V$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.P_;
        },
        enumerable: !1,
        configurable: !0
        ...
        if (this.m_) throw new C(V$1.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
            ...
            switch (t.type) {
              case "gapi":
                ...
                // Make sure this really is a Gapi client.
                                return R$1(!("object" != typeof e || null === e || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)), 
              ...
              default:
                throw new C(V$1.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
 ...
 */
        return function(t) {
            var e = Rs.get(t);
            e && (k$1("ComponentProvider", "Removing Datastore"), Rs.delete(t), e.terminate());
...
function Cs() {
    if ("undefined" == typeof Uint8Array) throw new C(V$1.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function qs() {
    if ("undefined" == typeof atob) throw new C(V$1.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
...
/** Immutable class holding a blob (binary data) */ var Ms = /** @class */ function(e) {
    ...
    return __extends$1(n, e), n.fromBase64String = function(t) {
    ...
    return __extends$1(n, e), n.prototype.x_ = function(t) {
        return new Ms(new Ss(t));
    }, n.prototype.F_ = function(t) {
        var e = this.L_(t, this.firestore.A_);
        return pc$1.B_(e, this.firestore, /* converter= */ null);
    }, n;
 ...
 */
function zs(t, e) {
    return "string" == typeof e ? ja$1(t, e) : e instanceof Ps ? e.o_.j_ : e.j_;
}
 ...
 */ var Gs = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new C(V$1.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.j_ = new X$1(t);
    }
    /**
    ...
    return __extends$1(n, e), n.prototype.S_ = function() {
        return this.z_ || 
        // The client must be initialized to ensure that all subsequent API
        // usage throws an exception.
        hc$1(this), this.z_.terminate();
    }, n;
}(Vs);
...
function Qs(t) {
    if (t.g_ || t.y_) throw new C(V$1.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
 ...
 */ var $s = /** @class */ function(e) {
    ...
    /** @hideconstructor */
    function t(t, e, n, r) {
        this.q_ = t, this.U_ = e, this.J_ = r, this.metadata = new mc$1(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this.J_.docs.forEach((function(r) {
            t.call(e, new Js(n.q_, n.U_, r.key, r, new mc$1(n.J_.ee.has(r.key), n.J_.fromCache), n.query.W_));
        }));
    }, 
    /**
    ...
    t.prototype.docChanges = function(t) {
        ...
        if (e && this.J_.se) throw new C(V$1.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e) {
            if (t.J_.te.W()) {
                ...
                return t.J_.docChanges.map((function(e) {
                    var r = new Js(t.q_, t.U_, e.doc.key, e.doc, new mc$1(t.J_.ee.has(e.doc.key), t.J_.fromCache), t.query.W_);
                    return e.doc, {
                        type: "added",
                        doc: r,
                        oldIndex: -1,
            ...
            return t.J_.docChanges.filter((function(t) {
                ...
                var n = new Js(t.q_, t.U_, e.doc.key, e.doc, new mc$1(t.J_.ee.has(e.doc.key), t.J_.fromCache), t.query.W_), i = -1, o = -1;
 ...
 */ function Xs(t, e) {
    return t instanceof $s && e instanceof $s ? t.q_ === e.q_ && t.Q_.isEqual(e.Q_) && (null === t.K_ ? null === e.K_ : t.K_.isEqual(e.K_)) && t.W_ === e.W_ : t instanceof Ys && e instanceof Ys && t.q_ === e.q_ && Ea$1(t.query, e.query) && t.metadata.isEqual(e.metadata) && t.J_.isEqual(e.J_);
}
...
function ta$1(t, e, n) {
    ...
    t = _s(t, ia);
    var o = _s(t.firestore, Ws), u = Ta$1(o);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    return e instanceof Ps && (e = e.o_), na$1(o, ("string" == typeof e || e instanceof Gs ? Ra$1(u, "updateDoc", t.Q_, e, n, r) : Pa$1(u, "updateDoc", t.Q_, e)).tf(t.Q_, an.exists(!0)));
}
 ...
 */ function ra$1(t, e, n) {
    ...
    return new $s(t, i, e.Q_, r, new mc$1(n.hasPendingWrites, n.fromCache), e.W_);
}
...
var aa$1 = /** @class */ function(e) {
    ...
    return __extends$1(n, e), n.prototype.nf = function(t) {
        var e = Ta$1(t.firestore), n = function(t, e, n, r, i, o, u) {
            var s;
            if (i.tt()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new C(V$1.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            ...
            return function(t, e) {
                if (e.An()) {
                    var n = qn(t);
                    if (null !== n && !n.isEqual(e.field)) throw new C(V$1.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
                    var r = Cn(t);
 ...
 */
                ...
                throw i === e.op ? new C(V$1.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new C(V$1.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, l), l;
        }(t.Z_, 0, e, t.firestore.A_, this.sf, this.rf, this.cf);
        return new oa$1(t.firestore, t.W_, function(t, e) {
    ...
    return __extends$1(n, e), n.prototype.nf = function(t) {
        var e = function(t, e, n) {
            if (null !== t.startAt) throw new C(V$1.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new C(V$1.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            var r = new ur(e, n);
            return function(t, e) {
                if (null === Cn(t)) {
    ...
    return __extends$1(n, e), n.prototype.nf = function(t) {
        return new oa$1(t.firestore, t.W_, jn(t.Z_, this.af, this.hf));
    }, n;
    ...
    return __extends$1(n, e), n.prototype.nf = function(t) {
        var e = pa$1(t, this.type, this.lf, this._f);
        return new oa$1(t.firestore, t.W_, function(t, e) {
...
function pa$1(t, e, n, r) {
    if (n[0] instanceof Ps && (n[0] = n[0].o_), n[0] instanceof js) return function(t, e, n, r, i) {
        if (!r) throw new C(V$1.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        ...
        for (var o = [], u = 0, s = Un(t); u < s.length; u++) {
            ...
            if (a.field.tt()) o.push(oe(e, r.key)); else {
                ...
                if (Wt(c)) throw new C(V$1.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var h = a.field.J();
                    throw new C(V$1.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    return function(t, e, n, r, i, o) {
        ...
        var u = t.Tn;
        if (i.length > u.length) throw new C(V$1.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var s = [], a = 0; a < i.length; a++) {
            var c = i[a];
            if (u[a].field.tt()) {
                if ("string" != typeof c) throw new C(V$1.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!Mn(t) && -1 !== c.indexOf("/")) throw new C(V$1.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var h = t.path.child(Y$1.Y(c));
                if (!Z$1.ot(h)) throw new C(V$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                var f = new Z$1(h);
                s.push(oe(e, f));
            } else {
                var l = La$1(n, r, c);
...
function da$1(t, e, n) {
    if (n instanceof Ps && (n = n.o_), "string" == typeof n) {
        if ("" === n) throw new C(V$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!Mn(e) && -1 !== n.indexOf("/")) throw new C(V$1.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(Y$1.Y(n));
        if (!Z$1.ot(r)) throw new C(V$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return oe(t, new Z$1(r));
    }
    if (n instanceof ia) return oe(t, n.Q_);
    throw new C(V$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + bs(n) + ".");
}
 ...
 * array requirements.
 */ function va$1(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new C(V$1.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new C(V$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}

function ya(t, e, n) {
    if (!n.isEqual(e)) throw new C(V$1.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}

function ma$1(t) {
    if (Vn(t) && 0 === t.Tn.length) throw new C(V$1.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
function wa$1(t, e) {
    ...
    if (t instanceof Ps && (t = t.o_), vs("collection", "path", e), t instanceof Vs) {
        var o = Y$1.Y.apply(Y$1, __spreadArrays([ e ], n));
        return ws(o), new ga(t, /* converter= */ null, o);
    }
    if (!(t instanceof ia || t instanceof ga)) throw new C(V$1.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var u = Y$1.Y.apply(Y$1, __spreadArrays([ t.path ], n)).child(Y$1.Y(e));
 ...
 */ function ba$1(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = z$1.D()), vs("doc", "path", e), t instanceof Vs) {
        var o = Y$1.Y.apply(Y$1, __spreadArrays([ e ], n));
        return gs(o), new ia(t, 
        /* converter= */ null, new Z$1(o));
    }
    if (!(t instanceof ia || t instanceof ga)) throw new C(V$1.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var u = t.ef.child(Y$1.Y.apply(Y$1, __spreadArrays([ e ], n)));
    return gs(u), new ia(t.firestore, t instanceof ga ? t.W_ : null, new Z$1(u));
}
...
function Ea$1(t, e) {
    return t instanceof Ps && (t = t.o_), e instanceof Ps && (e = e.o_), t instanceof oa$1 && e instanceof oa$1 && t.firestore === e.firestore && Bn(t.Z_, e.Z_) && t.W_ === e.W_;
}

function Ta$1(t) {
    var e = t.b_(), n = vr(t.A_);
    return new Oa$1(t.A_, !!e.ignoreUndefinedProperties, n);
}
...
/** The result of parsing document data (e.g. for a setData call). */ function ka$1(t) {
    switch (t) {
      case 0 /* Set */ :
 // fall through
              case 2 /* MergeSet */ :
...
/** A "context" object passed around while parsing user data. */ var xa = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.df = function(e) {
        ...
        return Ba$1(t, this.settings.methodName, this.settings.mf || !1, this.path, this.settings.h_);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (ka$1(this.u_) && Na$1.test(t)) throw this.a_('Document fields cannot begin and end with "__"');
    }, t;
}(), Oa$1 = /** @class */ function() {
    function t(t, e, n) {
...
/** Parse document data from a set() call. */ function Sa$1(t, e, n, r, i, o) {
    ...
    if (o.merge) s = new on(u.en), a = u.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            var p = Ua$1(e, l[f], n);
            if (!u.contains(p)) throw new C(V$1.INVALID_ARGUMENT, "Field '" + p + "' is specified in your field mask but missing from your input data.");
            za$1(h, p) || h.push(p);
        }
...
/** Parse update data from a list of field/value arguments. */ function Ra$1(t, e, n, r, i, o) {
    var u = t.Af(1 /* Update */ , e, n), s = [ Ua$1(e, r, n) ], a = [ i ];
    if (o.length % 2 != 0) throw new C(V$1.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var c = 0; c < o.length; c += 2) s.push(Ua$1(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = new Nn, l = s.length - 1; l >= 0; --l) if (!za$1(h, s[l])) {
        var p = s[l], d = a[l];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
 ...
 */ function La$1(t, e, n, r) {
    return void 0 === r && (r = !1), Va$1(n, t.Af(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Va$1(t, e) {
    ...
    // from firestore-exp.
    t instanceof Ps && (t = t.o_), qa$1(t)) return Ma$1("Unsupported field value:", e, t), 
    Ca$1(t, e);
    if (t instanceof Es) 
    ...
    return function(t, e) {
        ...
        if (!ka$1(e.u_)) throw e.a_(t._methodName + "() can only be used with update() and set()");
...
function qa$1(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof Q$1 || t instanceof Os || t instanceof Ss || t instanceof ia || t instanceof Es);
}

function Ma$1(t, e, n) {
    if (!qa$1(n) || !function(t) {
 ...
 */ function Ua$1(t, e, n) {
    ...
    if ("string" == typeof e) return ja$1(t, e);
    throw Ba$1("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function ja$1(t, e, n) {
    if (e.search(Fa$1) >= 0) throw Ba$1("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return (new (Gs.bind.apply(Gs, __spreadArrays([ void 0 ], e.split("."))))).j_;
    } catch (r) {
        throw Ba$1("Invalid field path (" + e + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
}

function Ba$1(t, e, n, r, i) {
    var o = r && !r.W(), u = void 0 !== i, s = "Function " + e + "() called with invalid data";
    n && (s += " (via `toFirestore()`)");
    var a = "";
    return (o || u) && (a += " (found", o && (a += " in field " + r), u && (a += " in document " + i), 
    a += ")"), new C(V$1.INVALID_ARGUMENT, (s += ". ") + t + a)
 ...
 */ var Ga$1 = /** @class */ function() {
    ...
    return t.prototype.Vf = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.pf(), this.mutations.length > 0) throw new C(V$1.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, r) {
                        return __awaiter(this, void 0, void 0, (function() {
                            ...
                            return __generator(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = L$1(t), i = De(e.serializer) + "/documents", o = {
                                    ...
                                    return u = n.sent(), s = new Map, u.forEach((function(t) {
                                        var n = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                R$1(!!e.found), e.found.name, e.found.updateTime;
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof xn || t instanceof kn ? i.vf(t) : P$1();
                    })), r) ];
                }
            }));
        }));
        ...
        if (n) {
            ...
            throw new C(V$1.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.bf = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new C(V$1.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    return t.prototype.run = function() {
        ...
        this.Si.Bs((function() {
            return __awaiter(t, void 0, void 0, (function() {
                var t, e, r = this;
                return __generator(this, (function(n) {
                    return t = new Ga$1(this.Mu), (e = this.Cf(t)) && e.then((function(e) {
                        r.di.Ri((function() {
    ...
    e, n) {
        var r = this;
        this.credentials = t, this.di = e, this.Fl = n, this.user = N$1.UNAUTHENTICATED, this.clientId = z$1.D(), 
        this.Ff = function() {}, this.g = new dr, this.credentials.A((function(t) {
            k$1("FirestoreClient", "Received user=", t.uid), r.user.isEqual(t) || (r.user = t, 
            r.Ff(t)), r.g.resolve();
        }));
    }
    ...
    t.prototype.Mf = function() {
        if (this.di.Ci) throw new C(V$1.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.terminate = function() {
        var t = this;
        this.di.Oi();
        var r = new dr;
 ...
 */ function Qa$1(t, r) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(u) {
            switch (u.label) {
              case 0:
                return t.di.Li(), k$1("FirestoreClient", "Initializing OfflineComponentProvider"), 
...
function $a$1(t, r) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(u) {
            switch (u.label) {
              case 0:
                return t.di.Li(), [ 4 /*yield*/ , Ja$1(t) ];

              case 1:
                return i = u.sent(), k$1("FirestoreClient", "Initializing OnlineComponentProvider"), 
                [ 4 /*yield*/ , t.getConfiguration() ];
                        ...
                        return function(t, r) {
                            return __awaiter(this, void 0, void 0, (function() {
                                ...
                                return __generator(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = L$1(t)).di.Li(), k$1("RemoteStore", "RemoteStore received new credentials"), 
                                        i = So(e), 
...
function Ja$1(t) {
    return __awaiter(this, void 0, void 0, (function() {
        return __generator(this, (function(e) {
            switch (e.label) {
              case 0:
                return t.$f ? [ 3 /*break*/ , 2 ] : (k$1("FirestoreClient", "Using default OfflineComponentProvider"), 
...
function Ya$1(t) {
    return __awaiter(this, void 0, void 0, (function() {
        return __generator(this, (function(e) {
            switch (e.label) {
              case 0:
                return t.kf ? [ 3 /*break*/ , 2 ] : (k$1("FirestoreClient", "Using default OnlineComponentProvider"), 
                [ 4 /*yield*/ , $a$1(t, new ps) ]);
                    ...
                    return e = function(t, e, n, r, i) {
                        var o = new ds({
                            next: function(o) {
                                ...
                                // if the document doesn't exist.
                                i.reject(new C(V$1.UNAVAILABLE, "Failed to get document because the client is offline.")) : s && o.fromCache && r && "server" === r.source ? i.reject(new C(V$1.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(o);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
                    ...
                    return e = function(t, e, n, r, i) {
                        var o = new ds({
                            next: function(n) {
                                ...
                                e.Ri((function() {
                                    return Ho(t, u);
                                })), n.fromCache && "server" === r.source ? i.reject(new C(V$1.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
...
var ic$1 = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this.q_ = t, this.Lf = e, this.Bf = [], this.qf = !1, this.Uf = Ta$1(t);
    }
    return t.prototype.set = function(t, e, n) {
        this.Qf();
        var r = oc$1(t, this.q_), i = Nc$1(r.W_, e, n), o = Sa$1(this.Uf, "WriteBatch.set", r.Q_, i, null !== r.W_, n);
        return this.Bf = this.Bf.concat(o.tf(r.Q_, an.on())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this.Qf();
        var o, u = oc$1(t, this.q_);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return e instanceof Ps && (e = e.o_), o = "string" == typeof e || e instanceof Gs ? Ra$1(this.Uf, "WriteBatch.update", u.Q_, e, n, r) : Pa$1(this.Uf, "WriteBatch.update", u.Q_, e), 
    ...
    t.prototype.commit = function() {
        ...
        if (this.qf) throw new C(V$1.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}();

function oc$1(t, e) {
    if (t instanceof Ps && (t = t.o_), t.firestore !== e) throw new C(V$1.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ var uc$1 = /** @class */ function(e) {
     ...
     */    return __extends$1(n, e), n.prototype.get = function(t) {
        var n = this, r = oc$1(t, this.q_), i = new Zs(this.q_);
        return e.prototype.get.call(this, t).then((function(t) {
            return new $s(n.q_, i, r.Q_, t.K_, new mc$1(
            /* hasPendingWrites= */ !1, 
            /* fromCache= */ !1), r.W_);
        }));
    }, n;
    ...
    /** @hideconstructor */
    function t(t, e) {
        this.q_ = t, this.Kf = e, this.Uf = Ta$1(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = oc$1(t, this.q_), r = new _a(this.q_);
        ...
        var r = oc$1(t, this.q_), i = Nc$1(r.W_, e, n), o = Sa$1(this.Uf, "Transaction.set", r.Q_, i, null !== r.W_, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return e instanceof Ps && (e = e.o_), o = "string" == typeof e || e instanceof Gs ? Ra$1(this.Uf, "Transaction.update", u.Q_, e, n, r) : Pa$1(this.Uf, "Transaction.update", u.Q_, e), 
    ...
    return t.prototype.enableIndexedDbPersistence = function(t, e) {
        ...
        return function(t) {
            Qs(t = _s(t, Ws));
            var e = cc$1(t), n = t.b_(), r = new ps;
            return Ks(e, r, new ls(r, n.cacheSizeBytes));
        }(t.o_);
    }, t.prototype.clearIndexedDbPersistence = function(t) {
        return function(t) {
            var r = this;
            if (t.g_ && !t.y_) throw new C(V$1.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
            var i = new dr;
 ...
 */;
    ...
    function i(t, e, n) {
        ...
        }, t instanceof T$1 || (i.jf = t), i;
    }
    return __extends$1(i, r), Object.defineProperty(i.prototype, "A_", {
        get: function() {
            return this.o_.A_;
        },
        enumerable: !1,
        ...
        "firestore.googleapis.com" !== this.o_.v_().host && O$1("Host has been set in both settings() and useEmulator(), emulator host will be used"), 
        this.settings({
            host: t + ":" + e,
            ssl: !1,
            merge: !0
                                ...
                                return i = o.sent(), [ 2 /*return*/ , (r.oc(!1), function(t) {
                                    return __awaiter(this, void 0, void 0, (function() {
                                        ...
                                        return __generator(this, (function(n) {
                                            switch (n.label) {
                                              case 0:
                                                return (e = L$1(t)).Bu.add(0 /* UserDisabled */), [ 4 /*yield*/ , To(e) ];
 ...
 */
        ...
        return function(t, r) {
            ...
            }(cc$1(t = _s(t, Ws)), yr(r) ? r : {
                next: r
            });
        }(this.o_, t);
    }, Object.defineProperty(i.prototype, "app", {
        get: function() {
            if (!this.jf) throw new C(V$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.jf;
        },
        enumerable: !1,
        configurable: !0
        ...
        try {
            return new bc$1(this, function(t, e) {
                if (t = _s(t, Vs), vs("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new C(V$1.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
                return new oa$1(t, 
                /* converter= */ null, function(t) {
                    return new Sn(Y$1.X(), t);
                }(e));
            }(this.o_, t));
        } catch (t) {
                    ...
                    return __awaiter(i, void 0, void 0, (function() {
                        ...
                        return __generator(this, (function(n) {
                            switch (n.label) {
                              ...
                              case 1:
                                return e = n.sent(), new Wa$1(t.di, e, r, o).run(), [ 2 /*return*/ ];
                            }
                        }));
                    }));
                })), o.promise;
 ...
 */ function cc$1(t) {
    return t.z_ || hc$1(t), t.z_.Mf(), t.z_;
}
...
}(Ps), lc$1 = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return __extends$1(n, e), n.prototype.set = function(t, e, n) {
        var r = Tc$1(t);
...
}(Ps), pc$1 = /** @class */ function(i) {
    function o(t, e) {
        var n = this;
        return (n = i.call(this, e) || this).firestore = t, n.U_ = new Fs(t), n;
    }
    return __extends$1(o, i), o.Gf = function(t, e, n) {
        if (t.length % 2 != 0) throw new C(V$1.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t.J() + " has " + t.length);
        ...
        return t instanceof Ps && (t = t.o_), t instanceof ia && Ia$1(this.o_, t);
    }, o.prototype.set = function(t, e) {
        e = ys("DocumentReference.set", e);
        try {
            return function(t, e, n) {
                t = _s(t, ia);
                var r = _s(t.firestore, Ws), i = Nc$1(t.W_, e, n);
                return na$1(r, Sa$1(Ta$1(r), "setDoc", t.Q_, i, null !== t.W_, n).tf(t.Q_, an.on()));
            }(this.o_, t, e);
        } catch (t) {
        ...
        return na$1(_s((t = this.o_).firestore, Ws), [ new In(t.Q_, an.on()) ]);
        var t;
        /**
 ...
 */    }, o.prototype.onSnapshot = function() {
        ...
        var r = vc$1(e), i = yc$1(e, (function(e) {
            return new gc$1(t.firestore, new $s(t.firestore.o_, t.U_, e.Q_, e.K_, e.metadata, t.o_.W_));
        }));
        ...
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
            t = _s(t, ia);
            var r = _s(t.firestore, Ws), i = cc$1(r), o = new Zs(r);
            return function(t, r) {
                var i = this, o = new dr;
                return t.di.Ri((function() {
                    return __awaiter(i, void 0, void 0, (function() {
                                    ...
                                    return __awaiter(this, void 0, void 0, (function() {
                                        ...
                                        return __generator(this, (function(n) {
                                            switch (n.label) {
                                              ...
                                              case 1:
                                                return (e = n.sent()) instanceof kn ? i.resolve(e) : e instanceof xn ? i.resolve(null) : i.reject(new C(V$1.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                                [ 3 /*break*/ , 3 ];
                ...
                return new $s(r, o, t.Q_, e, new mc$1(e instanceof kn && e.an, 
                /* fromCache= */ !0), t.W_);
            }));
        }
        /**
 ...
 */ (this.o_) : "server" === (null == t ? void 0 : t.source) ? function(t) {
            ...
            t = _s(t, ia);
            var e = _s(t.firestore, Ws);
            return nc$1(cc$1(e), t.Q_).then((function(n) {
                return ra$1(e, t, n);
            }));
        }(this.o_)).then((function(t) {
            return new gc$1(r.firestore, new $s(r.firestore.o_, r.U_, t.Q_, t.K_, t.metadata, r.o_.W_));
        }));
 ...
 */ var mc$1 = /** @class */ function() {
    ...
    return __extends$1(n, e), Object.defineProperty(n.prototype, "ref", {
        get: function() {
            return new pc$1(this.q_, this.o_.ref);
        },
        enumerable: !1,
        configurable: !0
    ...
    return __extends$1(i, r), i.prototype.where = function(t, e, n) {
        try {
        ...
        try {
            return new i(this.firestore, sa$1(this.o_, function(t) {
                return Is("limit", t), new ha$1("limit", t, "F" /* First */);
            }(t)));
        } catch (t) {
        ...
        try {
            return new i(this.firestore, sa$1(this.o_, function(t) {
                return Is("limitToLast", t), new ha$1("limitToLast", t, "L" /* Last */);
            }(t)));
        } catch (t) {
        ...
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
            ...
            t = _s(t, oa$1);
            var e = _s(t.firestore, Ws), n = cc$1(e), r = new Zs(e);
            return rc$1(n, t.Z_, {
                source: "server"
            }).then((function(n) {
            ...
            t = _s(t, oa$1);
            var e = _s(t.firestore, Ws), n = cc$1(e), r = new Zs(e);
            return ma$1(t.Z_), rc$1(n, t.Z_).then((function(n) {
                return new Ys(e, r, t, n);
            }));
        }(this.o_)).then((function(t) {
            return new Ic$1(r.firestore, new Ys(r.firestore.o_, r.U_, r.o_, t.J_));
        }));
    }, i.prototype.onSnapshot = function() {
        for (var t = this, e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        var r = vc$1(e), i = yc$1(e, (function(e) {
            return new Ic$1(t.firestore, new Ys(t.firestore.o_, t.U_, t.o_, e.J_));
        }));
        return ea$1(this.o_, r, i);
    ...
    return __extends$1(n, e), Object.defineProperty(n.prototype, "type", {
        get: function() {
            return this.o_.type;
        },
        enumerable: !1,
        ...
        get: function() {
            return new wc$1(this.q_, this.o_.doc);
        },
        enumerable: !1,
        configurable: !0
...
}(Ps), Ic$1 = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, n) || this).q_ = t, r;
    }
    return __extends$1(n, e), Object.defineProperty(n.prototype, "query", {
        get: function() {
            return new bc$1(this.q_, this.o_.query);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(n.prototype, "metadata", {
        ...
        this.o_.forEach((function(r) {
            t.call(e, new wc$1(n.q_, r));
        }));
    }, n.prototype.isEqual = function(t) {
        return Xs(this.o_, t.o_);
    }, n;
}(Ps), Ec$1 = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
    ...
    return __extends$1(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        var e = this;
        return function(t, e) {
            var n = _s(t.firestore, Ws), r = ba$1(t), i = Nc$1(t.W_, e);
            return na$1(n, Sa$1(Ta$1(t.firestore), "addDoc", r.Q_, i, null !== t.W_, {}).tf(r.Q_, an.exists(!1))).then((function() {
                return r;
            }));
 ...
 */ var Ac$1 = /** @class */ function(e) {
    ...
    return __extends$1(n, e), n.documentId = function() {
        /**
...
}(Ps), Dc$1 = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return __extends$1(n, e), n.serverTimestamp = function() {
...
function xc(t) {
    !function(t, e) {
        t.INTERNAL.registerComponent(new Component("firestore", (function(t) {
            return function(t, e) {
                return new ac$1(t, new Ws(t, e), new sc$1);
            }(t.getProvider("app").getImmediate(), t.getProvider("auth-internal"));
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, kc$1)));
